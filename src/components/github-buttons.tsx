...
export function GitHubButtons() {
  return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <Button 
        size="lg" 
        className="bg-white text-gray-900 hover:bg-gray-100 rounded-lg px-8"
        onClick={() => window.open('https://github.com/product-squaads/makeitvid/blob/main/README.md', '_blank')}
      >
        Read Documentation
